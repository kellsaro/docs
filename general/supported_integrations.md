...
![Integration Tab](/img/integration/integration_tab.jpg)
...
![Choose Environment](/img/integration/choose_environment.jpg)
...
![Integrator Login](/img/integration/integrator_login.jpg)
...
![Mandrill Configuration](/img/integration/mandrill_config.jpg)
...
![Active Integrations](/img/integration/active_integrations.jpg)
...
![Adding A Custom Integration](/img/integration/add_custom_integration.jpg)
...
![Pending Custom Integration](/img/integration/pending_custom_integration.jpg)
...
![Pending Integration Being Fetched](/img/integration/fetch_custom_integration.jpg)

If there are any errors in your endpoint's `endpoint.json` file this screen will automatically update and list the errors.

![Custom Integration With Errors](/img/integration/errors_custom_integration.jpg)
